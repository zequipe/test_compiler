!--------------------------------------------------------------------------------------------------!
! This is an example to illustrate the usage of COA.
!
! Coded by Zaikun ZHANG (www.zhangzk.net) based on Powell's Fortran 77 code.
!
! Started: July 2020
!
! Last Modified: Tuesday, February 22, 2022 PM08:33:41
!--------------------------------------------------------------------------------------------------!
...
! The following line makes COA available.
!--------------------------------------------------------------------------------------------------!
use coa_mod, only : coa
!--------------------------------------------------------------------------------------------------!
...
do n = 2, 10, 2
    ...
    ! The following line illustrates how to call COA.
    !----------------------------------------------------------------------------------------------!
    call coa(calcfc, x, f, rhobeg=0.2D0 * x(1), iprint=2)
    !----------------------------------------------------------------------------------------------!
    ...
    ! etc.) will take their default values coded in COA. You can also ignore all the optional
    ! arguments and invoke COA by the following line.
    !----------------------------------------------------------------------------------------------!
    ! call coa(calcfc, x, f)
    !----------------------------------------------------------------------------------------------!
end do
end subroutine test_coa
