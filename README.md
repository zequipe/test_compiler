...
* :ballot_box_with_check: [GNU `gfortran`](https://gcc.gnu.org/fortran/) 12.1.0 (fail: `test_char`)
...
* :negative_squared_cross_mark: [NAG `nagfor`](https://www.nag.com/content/nag-fortran-compiler) [Release 7.1](https://monet.nag.co.uk/compiler/r71download/) (Hanzomon) Build 7122 (fail: `test_sym`, `test_indices`)
