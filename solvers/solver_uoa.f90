...
use, non_intrinsic :: uob_mod, only : uob
...
character(len=*), parameter :: srname = 'UOA'
...
!-------------------- Call UOB, which performs the real calculations. --------------------------!
call uob(calfun, iprint_loc, maxfun_loc, npt_loc, eta1_loc, eta2_loc, ftarget_loc, gamma1_loc, &
